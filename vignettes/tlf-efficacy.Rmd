...
apr0ancova1 <- merge(t11, t12) %>%
  ...
  mutate(
    ...
    N1 = N,
    Mean1 = esubdemo::fmt_est(mean_bl, sd_bl),
    N2 = N,
    Mean2 = esubdemo::fmt_est(mean, sd),
    N3 = N,
    Mean3 = esubdemo::fmt_est(mean_chg, sd_chg),
    CI = esubdemo::fmt_ci(emmean, lower.CL, upper.CL)
  ) %>%
  select(Trt:CI)
...
apr0ancova2 <- t2 %>%
  ...
  mutate(
    ...
    mean = esubdemo::fmt_ci(estimate, lower, upper),
