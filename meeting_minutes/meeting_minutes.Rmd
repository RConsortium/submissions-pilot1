...
-   Participants: Joel Laxamana, Kangjie Zhang, Ben Straub, Robert
    Devine, Dadong Zhang, Declan Hodges, Nicole Jones, Lei Zhao, Bingjun Wang
-   Summary: Discussed tasks still in progress 
-   Project Board: <https://github.com/orgs/RConsortium/projects/7>
-   Meeting Recorded: Yes : https://drive.google.com/file/d/1sQobfAP2YzpFAJujRhDKyCkwzdeHxk9L/view?usp=sharing 
...
-   Joel has made updates to specs to help resolve our P21 issues. Only
    ...
    should be resolvable as we remove all reference to datasets, codelists,
    variables from datasets that we are not generating in Pilot 3.
...
-   Steven updated script for adtte.R to call on {Pilot3} and path to the ADaMs generated in our Pilot.
